...
final class Page
{
	...
	private function getFirst()
	{
		if($this->page==1){
			...
			return 
            "<li class='page-item'><a class='page-link' href='$this->url"."1'>처음</a></li>";
		}
	}
	...
	private function getLast()
	{
		if($this->page==$this->pages){
			...
			return "<li class='page-item'><a class='page-link' href='$this->url"."$this->pages'>마지막</a></li>";
		}
	}
	...
	private function getPrev()
	{
		...
		}else
		{
			return             
            "<li class='page-item'>
                <a class='page-link' href='{$this->prev}' aria-label='Previous'>
    ...
    private function getPageMid(){
        ...
        for ($i = $start_page; $i <= $end_page; $i++) {
            if ($i == $this->page) {
                $this->midPage .= "<li class='page-item active'><a class='page-link'>$i</a></li>";
            } else {
                $this->midPage .= "<li class='page-item'><a class='page-link' href='$this->url"."$i'>$i</a></li>";
            }
        }
    }
	...
	public function showPage()
	{
		...
		{
			return "<li class='page-item active'><a class='page-link'>1</a></li>";
		}
	}
}