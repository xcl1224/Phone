...
class ChinaPhoneController extends BaseController{
    ...
    public function index(){
        ...
        $phoneData = PhoneModel::getInstance()->ChinaData($where,$startrow,$pageSize);
    ...
    public function single(){
            if(!empty($_GET['phone_num'])){
               $singleData = PhoneModel::getInstance()->chinaSingle($_GET['phone_num']);
